...
void panel(void)
{
	...
	/*ボタンは0番から7番まで8個ある*/
	DGIN_PROC( I_07,20, LOW,10,fTrg10ms);/*0番*/
	...
	if((I_07 == HIGH) || (I_15 == HIGH)){
		DGOUT_PROC( 30, fOFF, LOW );/*LED1　左*/
		DGOUT_PROC( 31, fOFF, LOW );/*LED2　中央*/
		DGOUT_PROC( 32, fOFF, LOW );/*LED3　右*/
	}
	if((I_09 == HIGH) || (I_17 == HIGH)){
		DGOUT_PROC( 30, fOFF, LOW );/*LED1　左*/
		DGOUT_PROC( 31, fOFF, LOW );/*LED2　中央*/
		DGOUT_PROC( 32, fON, LOW );/*LED3　右*/
	}
	if((I_11 == HIGH) || (I_19 == HIGH)){
		DGOUT_PROC( 30, fOFF, LOW );/*LED1　左*/
		DGOUT_PROC( 31, fON, LOW );/*LED2　中央*/
		DGOUT_PROC( 32, fOFF, LOW );/*LED3　右*/
	}
	if((I_13 == HIGH) || (I_21 == HIGH)){
		DGOUT_PROC( 30, fON, LOW );/*LED1　左*/
		DGOUT_PROC( 31, fOFF, LOW );/*LED2　中央*/
		DGOUT_PROC( 32, fOFF, LOW );/*LED3　右*/
	}
}
